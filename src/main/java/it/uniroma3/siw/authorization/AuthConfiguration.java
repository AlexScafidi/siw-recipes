package it.uniroma3.siw.authorization;
...
@EnableWebSecurity
    ...
    protected SecurityFilterChain configure(final HttpSecurity httpSecurity) throws Exception{
        httpSecurity
                ...
                .requestMatchers(HttpMethod.GET,"/","/index", "/categories/**", "/category/**", "/recipes/**", "/recipe/**", "/ingredients/**", "/registration", "/login", "/success", "/css/**", "/images/**").permitAll()
